...
describe('createInstallObject', () => {
  ...
  describe('Install from remote repository URL', () => {
    describe('with branch', () => {
      beforeEach(() => {
        env.installObject = createInstallObject(
          'https://bitbucket.org/webpack/raw-loader#my-branch'
        );
      });
    ...
    describe('without branch', () => {
      beforeEach(() => {
        env.installObject = createInstallObject(
          'https://bitbucket.org/webpack/raw-loader'
        );
      });
