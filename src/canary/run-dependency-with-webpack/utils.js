 ...
 */
export function applyReplacements(exampleCompilerCommand) {
  return reduce(
    REPLACEMENT_MAPPING,
    (command, { replacement, replaceable }) =>
 ...
 */
export function containsSuccessMessage(stdout) {
  return (
    stdout.indexOf('webpack: bundle is now VALID') > -1 ||
 ...
 */
export function getOutputUrl(stdout) {
