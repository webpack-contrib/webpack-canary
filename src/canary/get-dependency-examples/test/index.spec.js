...
describe('getDependencyExamples', () => {
  ...
  beforeEach(() => {
    ...
    env.examplesPromise = env.getDependencyExamples(
      env.webpack,
      env.dependency,
      'examples'
    );
  ...
  describe('when provided example paths', () => {
    beforeEach((done) => {
      ...
      env.demoExamplesPromise = getDependencyExamples(
        env.webpack,
        env.dependency,
        './demo'
      );
    ...
    it('should find examples in provided paths', () =>
      env.demoExamplesPromise.then(
        (data) =>
  ...
  describe('when one example found', () => {
    ...
    it('calls the callback with array of one config', () =>
      env.examplesPromise.then(
        (data) =>
          expect(data).to.deep.equal([
            {
  ...
  describe('when no examples found', () => {
    ...
    it('calls the callback with empty array', () =>
      env.examplesPromise.then(
