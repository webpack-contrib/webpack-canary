 ...
 */
export default async function (webpackSetup, dependencySetup, packageManager) {
  ...
  const stdout = await runCommand(commands.install, ROOT_PATH);
  ...
  return runCommand(commands.installDeps, dependencySetup.installLocation);
}
