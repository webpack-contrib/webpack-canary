...
describe('getDependencyExamples', function() {
  ...
  it('searches within the dependency examples', function() {
    sinon.assert.calledWith(env.globMock, '**/webpack.config.js', { cwd: `${MODULES}/raw-loader/examples` });
    sinon.assert.calledWith(env.globMock, '**/webpack.config.js', { cwd: `${MODULES}/raw-loader/example` });
  });
